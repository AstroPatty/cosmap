...
class CosmapDataset(Protocol):
    ...
    def cone_search(self, center: SkyCoord, radius: u.Quantity, dtypes: list, *args, **kwargs) -> dict:
        """
        A basic cone search utility. This should return a dictionary with the keys matching
        the dtype names, and the values being the data. 
        """
        pass
