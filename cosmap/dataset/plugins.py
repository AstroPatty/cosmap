...
some data types cannot be pickled, so we need the worker to have direct access to the dataset.

This means we do have spin up one copy of the dataset for each worker. We hope to improve this in
the futre.
"""
